    ...
    <div class="row">
        <div class="card col-md-12" style="background-color: 	#C0C0C0; padding-bottom: 15px; min-height: 600px">
            <div class="card-header" style="text-align: center;">
                <h2 style="color: black">Treated Patients' History</h2> 
            </div>
            <div> <asp:Label ID="PHistory" runat="server"></asp:Label></div>
            <ul class="list-group list-group-flush">
                <li class="list-group-item" style="background-color: 	#C0C0C0;" > 
                                                                                                                                                                                                                                                                                       <asp:gridview ID="PHistoryGrid" runat="server" CellPadding="4" ForeColor="Black" Height="50px" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" GridLines="Vertical">
                        <AlternatingRowStyle BackColor="White" />
                        <FooterStyle BackColor="#CCCC99" />
                        <HeaderStyle BackColor="#6B696B" Font-Bold="True" ForeColor="White" />
                        <PagerStyle BackColor="#F7F7DE" ForeColor="Black" HorizontalAlign="Right" />

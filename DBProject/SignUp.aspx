...
<head runat="server">
    ...
    <title>TotalCare Clinic Login &amp; Register</title>
               ...
               <div class="container">
                   ...
                   <div class="row">
                         <div class="col-sm-8 col-sm-offset-2 text">
                            ...
                            <h1><strong>Salomon's HealthCare Center</strong> Login &amp; Registration Form</h1>
                            
                            <div class="description">
                            	<p>
	                            	This is a free <strong>"Login and Registration form"</strong> for TotalCare Clinic  
                            	</p>                            
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-box">
                                <div class="form-top">
                                    <div class="form-top-left">
	                            		...
	                            		<p style="color: white">Enter Email and Password to log in:</p>
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Sign up now</h3>
	                            		<p style="color: white">Fill in the form below to get instant access:</p>
	                        		</div>
	                        		<div class="form-top-right">

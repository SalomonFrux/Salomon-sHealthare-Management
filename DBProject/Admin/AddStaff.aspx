...
<body style="background-color: #d35400">
    <form id="form1" runat="server">
        ...
        <link rel="stylesheet" href="/assets/font-awesome/css/font-awesome.min.css"/>
            ...
            <%--<link rel="stylesheet" href="/Update/bootstrap-4/css/bootstrap.min.css" />--%>
            ...
            <div>
                ...
                <div class="container grad">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-sm-offset-2" style="color: white; margin-top: 30px" >
                        <hr/>
                            <h1 style="color: white"> <strong>Salomon's HealthCare Center</strong> Staff Registration Form</h1>
                            <hr/>
                            <div class="description">
                            	<p style="color: white">
	                            	This is a <strong>"registeration form"</strong> for Salomon's HealthCare Center. 

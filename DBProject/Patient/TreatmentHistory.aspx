...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <div class="container-fluid" style="background-color: #000000; height: 600px">
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12" style="text-align: center">
                        <hr/>
                        <h1 style="color: white"><strong >My Treatment History</strong></h1>
                        <hr/>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="col-md-12">
                <asp:GridView ID="THistoryGrid" runat="server" class = "GridView-d" CellPadding="4" ForeColor="white" GridLines="Vertical"  Width="100%" 
